<div class="min-h-screen bg-white p-4">
    <!-- Content -->
    <div id="activeOrderContent" class="p-4">
        <h2 class="text-center text-xl font-bold">Active Order Content</h2>
        <p class="text-center">This is the content for Active Orders.</p>
    </div>

    <!-- Hitory content -->
    <div id="historyContent" class="max-w-6xl mx-auto">
        <!-- Header -->
        <div class="text-center mb-6">
            <h1 class="text-3xl font-bold text-blue-600">Riwayat Pembelian</h1>
            <p class="text-gray-600 text-sm">Lihat detail transaksi Anda dengan mudah</p>
        </div>
        ...
        <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="mx-auto p-6 pb-1 border bg-white rounded-md shadow-dashboard">
                    <div class="flex flex-wrap items-center justify-between mb-1 -m-2">
                        <div class="w-auto p-2">
                            <h2 class="text-lg font-semibold text-coolGray-900">TRX20241210</h2>
                            <a href="#" class="text-sm text-green-500 hover:text-green-600 font-semibold">Rp.
                                100.000</a>
                        </div>
                        <div class="w-auto ">
                            <p class="text-xs text-coolGray-500">Tanggal: 22/12/2024</p>
                        </div>
                    </div>
                    <button id="dropdownButton1"
                        class="w-full py-2 text-sm font-medium text-coolGray-900 bg-gray-100 rounded-md hover:bg-gray-200 mb-4"
                        onclick="toggleDropdown('dropdownContent1')">
                        Lihat Detail
                    </button>
                    <div id="dropdownContent1" class="hidden flex flex-wrap">
            ...
            <div class="container px-4 mx-auto">
                <div class="mx-auto p-6 pb-1 border bg-white rounded-md shadow-dashboard">
                    ...
                    <div id="dropdownContent2" class="hidden flex flex-wrap">
                        <div class="w-full border-b border-coolGray-100">
                            <div class="flex flex-wrap items-center justify-between py-4 -m-2">
                                <div class="w-auto p-2">
                                    <div class="flex flex-wrap items-center -m-2">
            ...
            <div class="container px-4 mx-auto">
                <div class="mx-auto p-6 pb-1 border bg-white rounded-md shadow-dashboard">
                    ...
                    <div id="dropdownContent3" class="hidden flex flex-wrap">
                        <div class="w-full border-b border-coolGray-100">
                            <div class="flex flex-wrap items-center justify-between py-4 -m-2">
                                <div class="w-auto p-2">
                                    <div class="flex flex-wrap items-center -m-2">
            ...
            <div class="container px-4 mx-auto">
                <div class="mx-auto p-6 pb-1 border bg-white rounded-md shadow-dashboard">
                    ...
                    <div id="dropdownContent4" class="hidden flex flex-wrap">
                        <div class="w-full border-b border-coolGray-100">
                            <div class="flex flex-wrap items-center justify-between py-4 -m-2">
                                <div class="w-auto p-2">
                                    <div class="flex flex-wrap items-center -m-2">
            ...
            <div class="container px-4 mx-auto">
                <div class="mx-auto p-6 pb-1 border bg-white rounded-md shadow-dashboard">
                    ...
                    <button id="dropdownButton5"
                        class="w-full py-2 text-sm font-medium text-coolGray-900 bg-gray-100 rounded-md hover:bg-gray-200 mb-4"
                        onclick="toggleDropdown('dropdownContent5')">
                        Lihat Detail
                    </button>
                    <div id="dropdownContent5" class="hidden flex flex-wrap">
                        <div class="w-full border-b border-coolGray-100">
                            <div class="flex flex-wrap items-center justify-between py-4 -m-2">
                                <div class="w-auto p-2">
                                    <div class="flex flex-wrap items-center -m-2">
        ...
        <div id="empty-message" class="hidden mt-12 text-center text-gray-500">
            <svg class="mx-auto h-16 w-16 text-gray-300" fill="none" stroke="currentColor" stroke-width="2"
                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" d="M3 10h11M9 21V3m9 7h3M15 21V3"></path>
            </svg>
            <p class="mt-4 text-lg">Belum ada transaksi yang tercatat</p>
        </div>
    </div>
</div>

<div id="floatingTabs"
    class="fixed bottom-4 left-1/2 transform -translate-x-1/2 bg-white shadow-2xl rounded-xl p-4 w-11/12 max-w-md border-[3px] border-red-400 transition-opacity duration-300">
    <div class="grid grid-cols-2 gap-4">
        <button id="activeOrderTab"
            class="w-full px-4 py-2 bg-red-500 text-white rounded-full border border-red-400 text-center"
            onclick="switchTab('activeOrder')">Active Order</button>
        <button id="historyTab"
            class="w-full px-4 py-2 bg-white text-red-500 rounded-full border border-red-400 text-center"
...
<script>
    ...
    function switchTab(tab) {
        const activeTab = document.getElementById('activeOrderTab');
        ...
        if (tab === 'activeOrder') {
            ...
            activeTab.classList.remove('bg-white', 'text-red-500');
            historyTab.classList.add('bg-white', 'text-red-500');
            historyTab.classList.remove('bg-red-500', 'text-white');
            activeContent.classList.remove('hidden');
            historyContent.classList.add('hidden');
        } else {
            historyTab.classList.add('bg-red-500', 'text-white');
            historyTab.classList.remove('bg-white', 'text-red-500');
            activeTab.classList.add('bg-white', 'text-red-500');
            activeTab.classList.remove('bg-red-500', 'text-white');
