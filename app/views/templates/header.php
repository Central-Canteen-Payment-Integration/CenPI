<body>
	<header class="mb-4 md:mb-10">
			...
			<div class="navbar-end gap-2 md:gap-3">
				...
				<?php if (!isset($_SESSION['user'])) { ?>
					<a href="<?= BASE_URL ?>/User/login">
						<button class="btn btn-active btn-neutral btn-sm md:btn-md">Login</button>
					</a>
					<a href="<?= BASE_URL ?>/User/register" class="hidden md:inline">
						<button class="btn btn-active btn-primary btn-sm md:btn-md">Register</button>
					</a>
				<?php } else { ?>
		...
		<!-- Mobile Search Bar -->
		<div id="mobile-search-bar" class="block p-4 bg-gray-100 rounded-lg shadow-md max-w-3xl w-full mx-auto md:hidden">
